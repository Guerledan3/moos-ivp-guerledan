...
def get_top_lef(i, j):
    return [corner1[0]+i*L+(L-U)/2, corner1[1]+(j+1)*L]

def get_top_rig(i, j):
    return [corner1[0]+(i+1)*L-(L-U)/2, corner1[1]+(j+1)*L]

def get_bot_lef(i, j):
    return [corner1[0]+i*L+(L-U)/2, corner1[1]+j*L]

def get_bot_rig(i, j):
    return [corner1[0]+(i+1)*L-(L-U)/2, corner1[1]+j*L]

def get_lef_top(i, j):
    return [corner1[0]+i*L, corner1[1]+(j+1)*L-(L-U)/2]

def get_lef_bot(i, j):
    return [corner1[0]+i*L, corner1[1]+j*L+(L-U)/2]

def get_rig_top(i, j):
    return [corner1[0]+(i+1)*L, corner1[1]+(j+1)*L-(L-U)/2]

def get_rig_bot(i, j):
    return [corner1[0]+(i+1)*L, corner1[1]+j*L+(L-U)/2]

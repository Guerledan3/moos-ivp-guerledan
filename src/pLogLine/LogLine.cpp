...
<<<<<<< HEAD
  ...
  filename_archive  << archive_prefix << "/ins/F" << current_line << "_Time_" << asctime(timeinfo) << ".txt";
  archive_file.open(filename_archive.str().c_str(), ios::out | ios::trunc);
...
<<<<<<< HEAD
  ...
  stringstream filename_archive;
  filename_archive << archive_prefix << "/F" << current_line << "_Time_" << asctime(timeinfo) << ".txt";
  archive_file.open(filename_archive.str().c_str(), ios::out | ios::trunc);
